...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="shadow content-container">
    ...
    <div class="buttons-container">
      <a class="button" href="http://spa-vue-lara.test/" target="_blank"><span class="fa fa-home"></span> Go to homepage</a>
      <a class="button" href="mailto:michaelzhong833@gmail.com" target="_blank"><span class="fa fa-warning"></span> Report a problem</a>
    </div>
  </div>
</center>
