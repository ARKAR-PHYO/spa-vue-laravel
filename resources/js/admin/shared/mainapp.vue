<template>
    <div class="flex flex-row h-screen">
            <div v-if="isLoggedIn" class="flex flex-col w-56 bg-gray-600">
            ...
            <div class="flex flex-col w-full">
                <!-- TOP NAV BAR -->
                <div v-if="isLoggedIn" class="flex flex-row items-center h-16 px-12 py-6 bg-gray-100 shadow-md">
