    ...
    <div class="flex items-center justify-center">
        <div class="w-full">
            <div class="flex items-center space-x-4">
                ...
                <button @click="addModal = true" class="flex flex-row items-center px-5 py-2 space-x-1 text-white transform bg-blue-400 rounded-md shadow-md focus:outline-none hover:scale-105">
                        ...
                        <tr v-for="(role,i) in roles" :key="i" v-if="roles.length" class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="px-6 py-3 text-center">
                                <div class="flex justify-center item-center">
                                    ...
                                    <!-- EDIT BUTTON -->
                                    <div @click="showEditModal(role, i)" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                        </svg>
                                    </div>
                                    <!-- DELETE BUTTON -->
                                    <div @click="showDeletingModal(role, i)" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
